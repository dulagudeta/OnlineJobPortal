...
<div class="job-header">
    ...
    <div class="company-info">
        <img src="../uploads/images/<?php echo $company_logo ?>" alt="<?= $company_name ?> Logo" class="company-logo">
        <div>
            <h3><?= $company_name ?></h3>
...
<div class="detail-section">
    ...
    <p><?= html_entity_decode($job_description) ?></p>
</div>
...
<div class="detail-section">
    ...
    <form action="" method="post">
        <button class="btn btn-primary" name="approve_job">Approve</button>
    </form>
    <?php 
